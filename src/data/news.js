...
// максимальная длинна текста = 185 символов

// максимальная длинна титульника = 45-50 символов
...
const news = [
    {
        ...
        text:  `Дорогие друзья, мы по вам очень скучили и ждем вновь на занятия. 
    ...
    }, 
    {
        ...
        text:  `В рамках мероприятия проводилось 3 разных соревнования. 
                Наши спортсмены покозали себя достойно и завоевали 
                серебрянную медаль в парной акробатике.`,
    },
