...
const servicesList = {
    ...
    children: [
        ...
        {
            id: 2,
            title: "Развивающая гимнастика для малышей",
    ...
    adults: [
        ...
        },
        {
            id: 6,
            title: "Бачата",
            text: "Один из самых простых по хореографии латиноамериканский танец.<br/>Главная особенность стиля — чувственный романтизм, пластика, гармония и импровизация!",
            background: bachata,
            href: "/",
            mark: "bachata",
        },
